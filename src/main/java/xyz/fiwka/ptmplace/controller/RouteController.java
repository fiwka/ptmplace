...
public class RouteController {
    ...
    @GetMapping("/{from}/{to}")
    public ResponseEntity<List<City>> findRoutesBetween(@PathVariable("from") Long fromId, @PathVariable("to") Long toId, TransportModeFilter filter, @RequestParam("departure") Long departure) {
